    ...
    var routes = [{
      ...
      children: [{
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            return Promise.all(
            /*! import() | deaths-details-deaths-details-module */
            [__webpack_require__.e("common"), __webpack_require__.e("deaths-details-deaths-details-module")]).then(__webpack_require__.bind(null,
            /*! ../deaths-details/deaths-details.module */
            "./src/app/pages/deaths-details/deaths-details.module.ts")).then(function (m) {
              return m.DeathsDetailsPageModule;
            });
          }
        }]
      }]
